...
```
![img1](lib/widget/absorbPointer/res/absortpointer_1.gif)
...
```
![img1](lib/widget/absorbPointer/res/absortpointer_2.gif)
...
```
![img1](lib/widget/absorbPointer/res/absortpointer_3.gif)
...
![img1](lib/widget/absorbPointer/res/absortpointer_4.gif)
AbsorbPointer在absorbing为false时，效果如下:<br>
![img1](lib/widget/absorbPointer/res/absortpointer_5.gif)
...
![img1](lib/widget/absorbPointer/res/absortpointer_6.gif)
IgnorePointer在ignoring为false时,效果如下:<br>
![img1](lib/widget/absorbPointer/res/absortpointer_7.gif)